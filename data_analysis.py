...
def plot_time():
    ...
    plot_line(names,values_median_time_bfs,'BFS','Level','Time (s)','Mean Time evolution in BFS','bfs_time_line')
    plot_bar(names,values_median_time_bfs,'BFS','Level','Time (s)','Mean Time evolution in BFS','bfs_time_bar')
    plot_line(names,values_median_time_aStar,'aStar','Level','Time (s)','Mean Time evolution in aStar','aStar_time_line')
    plot_bar(names,values_median_time_aStar,'aStar','Level','Time (s)','Mean Time evolution in aStar','aStar_time_bar')
...
def plot_steps_group():
    ...
    plt.title("Mean Steps Evolution by Level")
    plt.legend()
    plt.tight_layout()
...
def plot_time_group():
    ...
    plt.xlabel('Difficulty Level')
    plt.title("Mean Time Evolution by Level")
    plt.legend()
    plt.tight_layout()
